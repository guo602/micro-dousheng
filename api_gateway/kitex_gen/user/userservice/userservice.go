...
func (p *kClient) Register(ctx context.Context, request *user.DouyinUserRegisterRequest) (r *user.DouyinUserRegisterResponse, err error) {
...
func (p *kClient) Login(ctx context.Context, request *user.DouyinUserLoginRequest) (r *user.DouyinUserLoginResponse, err error) {
...
func (p *kClient) GetUserById(ctx context.Context, request *user.DouyinUserRequest) (r *user.DouyinUserResponse, err error) {
