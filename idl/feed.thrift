...
struct DouyinFeedResponse {
  ...
  4: i64 next_time; // 本次返回的视频中，发布最早的时间，作为下次请求时的 latest_time
}
...
service FeedService {
  DouyinFeedResponse ListVideos(1: DouyinFeedRequest request)
  video_id_request QueryVideos(1: Video video)
}
